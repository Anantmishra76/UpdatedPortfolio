        ...
        <div className="w-full max-w-5xl">
          ...
          >
            <h1 className="font-display leading-none tracking-tighter text-[15vw] sm:text-[12vw] md:text-hero">
              <span className="block text-white">ANANT</span>
              <span className="block text-white">MISHRA</span>
            ...
            >
              MERN Stack Developer experienced in end-to-end web development — from responsive React frontends to Node.js/Express backends, with hands-on production deployments.
            </motion.p>
          </motion.div>
        </div>
      </div>
