...
const experiences = [
  {
    ...
    company: 'Binazy Pvt. Ltd.',
    location: 'India',
    period: 'Apr 2026 — Present',
    description: 'Building and deploying client-facing MERN applications with API integrations and third-party services. Managing production hosting, deployments, and UI performance optimization.',
    skills: ['MongoDB', 'Express.js', 'React.js', 'Node.js', 'Deployment', 'API Integration'],
  },
  {
    title: 'MERN Stack Developer',
    company: 'OCIdigitech',
    ...
    description: 'Developed and maintained production web applications using the MERN stack. Contributed to client projects across MongoDB, Express.js, React.js, and Node.js.',
    skills: ['MERN', 'REST APIs', 'CRUD', 'Production Apps', 'Client Projects'],
  },
]
