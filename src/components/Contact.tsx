  ...
  return (
    <section id="contact" className="section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div {...fadeInUp} className="mt-8 pt-12 lg:pt-16 border-t border-gray-800">
          <p className="text-sm text-gray-500 mb-6 lg:mb-8 tracking-widest uppercase">
            Reach me directly
          </p>
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 sm:gap-8 md:gap-12">
            <a
              href="mailto:anantmishra727@gmail.com"
              className="text-lg lg:text-xl text-gray-300 hover:text-white transition-colors underline underline-offset-4"
            >
              anantmishra727@gmail.com
            </a>
            <a
              href="tel:+917678649665"
              className="text-lg lg:text-xl text-gray-300 hover:text-white transition-colors underline underline-offset-4"
            >
              +91 76786 49665
            </a>
        ...
        >
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Anant Mishra. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">Lucknow, India</p>
        </motion.footer>
      </div>
    </section>
  )
