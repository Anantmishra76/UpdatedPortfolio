...
const navItems = [
  ...
  { id: 'writing', label: 'Projects' },
  { id: 'speaking', label: 'Certifications' },
]

const socialLinks = [
  { label: 'Mail', href: 'mailto:anantmishra727@gmail.com' },
  { label: 'LinkedIn', href: 'https://linkedin.com/in/anant-mishra76' },
  { label: 'GitHub', href: 'https://github.com/Anantmishra76' },
]
